...
`legacy/v1/` preserves the previous root context-layer shape for comparison and migration review. It is not a runtime retrieval root; active tools should continue reading `agent-context/`, `agent-context/v2/`, and `agent-context/sources/`.
